            ...
            <div class="card-body">
                <form action="<?= base_url('users/update/' . $user['id_user']) ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= ($validation->hasError('nm_user')) ? 'is-invalid' : ''; ?>" id="nm_user" name="nm_user" value="<?= (old('nm_user')) ? old('nm_user') : $user['nm_user'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="custom-select <?= ($validation->hasError('status')) ? 'is-invalid' : ''; ?>" id="status" name="status">
                                <option value="<?= (old('status')) ? old('status') : $user['status'] ?>">
                                    <?= (old('status')) ? old('status') : $user['status'] ?>
                                </option>

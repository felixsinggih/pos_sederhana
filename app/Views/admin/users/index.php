    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>
                    <a href="<?= base_url('users/add') ?>" class="btn btn-primary"><i class="fas fa-user-plus"></i> Tambah</a>
                </p>
                    ...
                    <tbody>
                        ...
                        foreach ($user as $data) : ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="<?= base_url('users/' . $data['id_user']) ?>" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
